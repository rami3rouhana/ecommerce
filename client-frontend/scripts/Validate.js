export const Validate = async () => {
    ...
    if (typeof dataJWt.data.jwt !== "undefined") {
        ...
        if (window.location.href !== "http://127.0.0.1:5500/client-frontend/landing-page.html" && window.location.href !== "http://127.0.0.1:5500/client-frontend/index.html" && !window.location.href.includes("http://127.0.0.1:5500/client-frontend/reset-password.html") )
